...
class ResNet(nn.Module):
    def __init__(self, ResBlock, layer_list, num_classes=9, num_channels=3):
...
def ResNet10(num_classes=9, channels=3):
    return ResNet(Block, [1, 1, 1, 1], num_classes, channels)

def ResNet18(num_classes=9, channels=3):
    return ResNet(Block, [2, 2, 2, 2], num_classes, channels)

def ResNet50(num_classes=9, channels=3):
